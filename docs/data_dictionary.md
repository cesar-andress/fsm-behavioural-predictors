...
Frozen campaign records and derived analysis tables in `data/raw/` and `data/processed/` are archived with the replication package on Zenodo: [10.5281/zenodo.20738203](https://doi.org/10.5281/zenodo.20738203). See [zenodo_record.md](zenodo_record.md).

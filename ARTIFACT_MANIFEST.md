...
**Primary orchestrator:** `make reproduce` (`run_strengthened_stats.py` + methodological-upgrade scripts)  
...
| Step 2 — definability audit | `tab:definibility-audit` | `definability_audit.py` | `outputs/tables/definability_audit.csv`, `definability_audit_summary.csv` | EMBEDDED |
...
| Manuscript anchor | Label | Source script | Generated output | Status |
|-------------------|-------|---------------|------------------|--------|
| Step 2 — definability map | `fig:definibility-map` | `strengthened_figures.py` | `outputs/figures/definability_map.png` | OK |
